...
public class PopuladorDeMatrizesEspiraisTest {
	...
	private CriadorDeMatrizesZeradas criadorDeMatrizesZeradas;

	@Before
	public void instanciarPopuladorDeMatrizesEspirais() {
		populador = new PopuladorDeMatrizesEspirais();
		criadorDeMatrizesZeradas = new CriadorDeMatrizesZeradas();
	}

	@Test
	public void devePopular1x1() {
		Integer[][] matriz = criadorDeMatrizesZeradas.criar(1, 1);
	...
	public void devePopular4x5() {
		Integer[][] matriz = criadorDeMatrizesZeradas.criar(4, 5);
		populador.popular(matriz);
	...
	public void devePopular6x3() {
		Integer[][] matriz = criadorDeMatrizesZeradas.criar(6, 3);
		populador.popular(matriz);
